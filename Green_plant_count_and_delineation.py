...
# set lower limits to object size
min_area = 9
...
#input img_path
img_path = r'D:\700 Georeferencing\AZ91 - Broccoli\Results/20190527_RGB.tif'
#output file directory
out_path = r'D:\700 Georeferencing\AZ91 - Broccoli\Temp_results'
...
def cluster_objects(x_block_size, y_block_size, it, img_path, out_path, kmeans_init, iterative_fit, run_classification):    
    ...
    kernel2 = np.ones((2,9), dtype='uint8')
...
def contours2shp(template, process_full_image, model, out_path, min_area):
    ...
    df = df[(df['area'] > min_area)]# & (df['area'] < 1600)]
...
if process_full_image == True:
    contours2shp(template, process_full_image, model, out_path, min_area)
